...
def parse_inn(inn):
    try:
        response = requests.get(f'https://api-fns.ru/api/search?q={inn}&key=9d0d634994dd65988ebc3044c1af926661749ebe')
...
if __name__ == "__main__":
    print(parse_inn("623008230466"))
    response = check_status("623008230466")
    print(response)
